...
import Controladores.ControladorGrupoSanguineo;
...
public class PanelRegistrarPaciente extends javax.swing.JPanel {
    private Color col;
    private ArrayList<Alergia> alergiasPac = new ArrayList();
    private ArrayList<Alergia> alergias = new ArrayList();
    private GrupoSanguineo TipoSangreTemp;
    public PanelRegistrarPaciente(Color col) {
        initComponents();
        ObtenerDatos();
        ObtenerGruposSanguienos();
    ...
    private void EstablecerColor(){
        ...
        jSeparator11.setForeground(col);    
    ...
    private void ObtenerGruposSanguienos(){
        try {
            ControladorGrupoSanguineo controladorGrupoSanguineo = new ControladorGrupoSanguineo();
            ArrayList<GrupoSanguineo> grupoSanguineos = new ArrayList();
            grupoSanguineos = controladorGrupoSanguineo.obtenerGruposSanguineos();
            for (GrupoSanguineo g : grupoSanguineos) {
                cbTipoSangre.addItem(g);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage(),  "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        cbTipoSangre = new javax.swing.JComboBox<GrupoSanguineo>();
        jLabel23 = new javax.swing.JLabel();
        cbAlergia = new javax.swing.JComboBox<Alergia>();
        ...
        add(lblFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 530, 860, 50));
        ...
        cbTipoSangre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbTipoSangreActionPerformed(evt);
            }
        });
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        try {
            ...
            paciente.setGrupoSanguineo(TipoSangreTemp);
            Date fecha = dpFechaNac.getDate();
            LocalDate FechaNacimiento = fecha.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
            paciente.setFechaNacimiento(FechaNacimiento);
            int idPacientetemp = consPa.registrar_paciente(paciente);
            for(Alergia indice : alergiasPac){
                JOptionPane.showMessageDialog(null, indice.getIdAlergia());
                controladorAlergia.agregarRelacionPacienteAlergia(idPacientetemp, indice.getIdAlergia());
            }
    ...
    private void btnNuevaAlergiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevaAlergiaActionPerformed
        JDialogAgregarAleriga a = new JDialogAgregarAleriga((JFrame)SwingUtilities.getWindowAncestor(PanelRegistrarPaciente.this), true);
    ...
    private void txtAgregarAlergiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAgregarAlergiaActionPerformed
        Alergia AlergiasSleccionada = (Alergia) cbAlergia.getSelectedItem();
        if (alergiasPac.contains(AlergiasSleccionada)) {
            JOptionPane.showMessageDialog(this, "Esta alergia ya esta registrada en este paciente", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
        alergiasPac.add(AlergiasSleccionada);
    ...
    private void cbTipoSangreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbTipoSangreActionPerformed
        TipoSangreTemp = (GrupoSanguineo)cbTipoSangre.getSelectedItem();
    ...
    private javax.swing.JComboBox<Alergia> cbAlergia;
    private javax.swing.JComboBox<String> cbGenero;
    private javax.swing.JComboBox<GrupoSanguineo> cbTipoSangre;
